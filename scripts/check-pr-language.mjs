...
// Dependency-free Node.js ESM script intended to be run from CI
// (see .github/workflows/release-pr.yml, which uses this to validate the
// auto-generated Release PR before posting the check-run result).
